...
public class Config {
    ...
    public Config(int aleatorioPorSeed, String modo, List<Integer> seeds, Map<String, Double> chegadas, Map<String, FilaDTO> filas, Map<String, Map<String, Double>> routing) {
